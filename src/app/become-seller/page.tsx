    ...
    <div className="max-w-3xl mx-auto px-4 py-10">
      <div className="rounded-2xl border p-6 md:p-8" style={{ background: "var(--panel)", borderColor: "var(--border)" }}>
        ...
        <div className="grid grid-cols-3 gap-3 mb-8">
          {[
            { icon: "arrow-up" as IconName, label: "فروش بیشتر" },
            { icon: "handshake" as IconName, label: "پشتیبانی کامل" },
            { icon: "banknote" as IconName, label: "تسویه هفتگی" },
          ].map((b) => (
            <div key={b.label} className="rounded-xl p-4 text-center" style={{ background: "var(--bg)" }}>
              <div className="mb-1 text-dk-red flex justify-center"><Icon name={b.icon} size={24} /></div>
