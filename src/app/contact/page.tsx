      ...
      <div className="rounded-2xl border p-6 md:p-8" style={{ background: "var(--panel)", borderColor: "var(--border)" }}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
          <div className="rounded-xl p-4 text-center" style={{ background: "var(--bg)" }}>
            <div className="flex justify-center mb-2 text-dk-red"><Icon name="phonecall" size={26} /></div>
          ...
          <div className="rounded-xl p-4 text-center" style={{ background: "var(--bg)" }}>
            <div className="flex justify-center mb-2 text-dk-red"><Icon name="mail" size={26} /></div>
          ...
          <div className="rounded-xl p-4 text-center" style={{ background: "var(--bg)" }}>
            <div className="flex justify-center mb-2 text-dk-red"><Icon name="clock" size={26} /></div>
        ...
        <div className="rounded-xl p-4 mb-8" style={{ background: "var(--bg)" }}>
          <div className="text-xs font-bold mb-1 flex items-center gap-1 justify-center"><Icon name="map-pin" size={14} /> آدرس</div>
