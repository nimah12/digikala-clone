  ...
  if (success) {
    return (
      <div className="max-w-md mx-auto px-4 py-16 text-center">
        ...
        <h1 className="text-xl font-extrabold mb-2">ثبت‌نام با موفقیت انجام شد</h1>
      ...
      <div className="rounded-2xl border p-6 md:p-8" style={{ background: "var(--panel)", borderColor: "var(--border)" }}>
        ...
        <div className="flex rounded-xl p-1 mb-6" style={{ background: "var(--bg)" }}>
          <button
            ...
            style={method === "email" ? { color: "#ef4050" } : { color: "var(--text-secondary)" }}
          >
            ایمیل
          </button>
          <button
            ...
            style={method === "phone" ? { color: "#ef4050" } : { color: "var(--text-secondary)" }}
          >
            شماره موبایل
          </button>
        </div>
