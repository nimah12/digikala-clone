...
const SECURITY_HEADERS: Record<string, string> = {
  ...
  "Content-Security-Policy": [
    ...
    "script-src 'self' 'unsafe-inline' https://*.public.blob.vercel-storage.com https://www.googletagmanager.com https://*.googletagmanager.com",
    "style-src 'self' 'unsafe-inline' https://www.googletagmanager.com https://*.googletagmanager.com",
    "img-src 'self' data: blob: https://*.public.blob.vercel-storage.com https://*.vercel-storage.com https://digikala-clone-media.nimah12.workers.dev https://*.google-analytics.com https://*.googletagmanager.com",
    "font-src 'self' data:",
    "connect-src 'self' https://*.public.blob.vercel-storage.com https://digikala-clone-media.nimah12.workers.dev https://*.backblazeb2.com https://*.google-analytics.com https://*.analytics.google.com https://*.googletagmanager.com",
